    ...
    <>
      <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
        <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
          ...
          <p className='text-[2.5rem] font-bold tracking-wide text-headingColor lg:text-[4.25rem] '>The Faster Delivery in <span className='text-orange-600 text-[3rem] lg:text-[5rem] '>Your City</span></p>
          <p className='text-base text-textColor text-center md:text-left md:w-[80%] '> Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel aliquid soluta beatae doloribus omnis iusto! Deleniti ad ea aspernatur illum vitae illo inventore harum reiciendis molestias tenetur, porro, autem architecto? </p>

          <button type='button' className='bg-gradient-to-br w-full md:w-auto from-orange-400 to-orange-500 px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out  '>Order Now</button>

        </div>
        <div className='py-2 flex-1 flex items-center relative'>
          <img src={HeroBg} className='ml-auto h-420 w-full lg:w-auto lg:h-650' alt="Hero_bg" />
